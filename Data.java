import java.sql.*; import java.util.*; class CallOutProc {
Connection con;
String url;
...
return url + serverName + ";instanceName = " +instanceName +" ;Da tabaseName = " +databaseName;
}
...
public static void main(String args[]) { CallOutProc proObj = new CallOutProc();
proObj.display();
}
}
