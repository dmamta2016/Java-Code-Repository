...
public class newdemo extends RecursiveTask<Integer> {
private static final int SEQUENTIAL_THRESHOLD = 5;
private final int[] data;
private final int startData;
private final int endData;
public newdemo(int[] data, int startValue, int
endValue) {
this.data = data;
this.startData = startValue;
this.endData = endValue;
}
public newdemo(int[] data) {
...
final newdemo leftValues = new newdemo(data, startData,
startData + midValue);
//forks all the small work units
leftValues.fork();
final newdemo rightValues = new newdemo(data,startData + midValue, endData);
